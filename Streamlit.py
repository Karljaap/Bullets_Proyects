...
# Interface with tabs
tab1, tab2 = st.tabs(["Companies & Waste Management", "School Construction Projects"])

with tab1:
    st.header("Companies & Waste Management in NYC")
    st.markdown("""
    ## Data Description
...
with tab2:
    st.header("School Construction Projects in NYC")
    st.markdown("""
    ## Data Description
